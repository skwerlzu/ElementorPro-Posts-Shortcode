...
/**
 * Main Agile Elementor Class
 *
 * The init class that runs the Agile Elementor plugin.
...
final class Agile_Elementor {
	...
	public function i18n() {
		load_plugin_textdomain( 'agile-elementor' );
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( AGILE_ELEMENTOR ) );
