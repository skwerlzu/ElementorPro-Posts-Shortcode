...
class Skin_Cards extends Skin_Base {
	...
	public function get_title() {
		return __( 'Cards', 'agile-elementor' );
	}
	...
	protected function register_thumbnail_controls() {
		...
		$this->update_control(
			'thumbnail',
			[
				'label' => __( 'Show Image', 'agile-elementor' ),
				'options' => [
					'top' => __( 'Yes', 'agile-elementor' ),
					'none' => __( 'No', 'agile-elementor' ),
				],
	...
	public function register_additional_design_image_controls() {
		...
		$this->add_control(
			'heading_badge_style',
			[
				'label' => __( 'Badge', 'agile-elementor' ),
		...
		$this->add_control(
			'badge_bg_color',
			[
				'label' => __( 'Background Color', 'agile-elementor' ),
		...
		$this->add_control(
			'badge_color',
			[
				'label' => __( 'Text Color', 'agile-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'badge_radius',
			[
				'label' => __( 'Border Radius', 'agile-elementor' ),
		...
		$this->add_control(
			'badge_margin',
			[
				'label' => __( 'Margin', 'agile-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_control(
			...
			[
				'label' => __( 'Avatar', 'agile-elementor' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					$this->get_control_id( 'thumbnail!' ) => 'none',
	...
	public function register_badge_controls() {
		$this->add_control(
			...
			[
				...
				'label_on' => __( 'Show', 'agile-elementor' ),
				'label_off' => __( 'Hide', 'agile-elementor' ),
				'default' => 'yes',
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			'badge_taxonomy',
			[
				'label' => __( 'Badge Taxonomy', 'agile-elementor' ),
	...
	public function register_design_card_controls() {
		...
		$this->add_control(
			'card_border_color',
			[
				'label' => __( 'Border Color', 'agile-elementor' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			'card_border_width',
			[
				'label' => __( 'Border Width', 'agile-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			'card_padding',
			[
				'label' => __( 'Horizontal Padding', 'agile-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Vertical Padding', 'agile-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Box Shadow', 'agile-elementor' ),
				'type' => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'hover_effect',
			[
				'label' => __( 'Hover Effect', 'agile-elementor' ),
				'type' => Controls_Manager::SELECT,
				'label_block' => false,
				'options' => [
					'none' => __( 'None', 'agile-elementor' ),
					'gradient' => __( 'Gradient', 'agile-elementor' ),
					//'zoom-in' => __( 'Zoom In', 'agile-elementor' ),
					//'zoom-out' => __( 'Zoom Out', 'agile-elementor' ),
				],
				'default' => 'gradient',
				'separator' => 'before',
		...
		$this->add_control(
			'meta_border_color',
			[
				'label' => __( 'Meta Border Color', 'agile-elementor' ),
				'type' => Controls_Manager::COLOR,
				'separator' => 'before',
				'selectors' => [
