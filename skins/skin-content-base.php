...
trait Skin_Content_Base {
	...
	public function get_title() {
		return __( 'Full Content', 'agile-elementor' );
	}
	...
	public function register_thumbnail_controls() {
		$this->add_control(
			'thumbnail',
			[
				'label' => __( 'Show Thumbnail', 'agile-elementor' ),
		...
		$this->add_responsive_control(
			'item_ratio',
			[
				'label' => __( 'Image Ratio', 'agile-elementor' ),
		...
		$this->add_responsive_control(
			'image_width',
			[
				'label' => __( 'Image Width', 'agile-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'%' => [
						'min' => 10,
	...
	public function register_row_gap_control() {
		$this->add_control(
			'row_gap',
			[
				'label' => __( 'Rows Gap', 'agile-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 35,
				],
	...
	public function render_post_content( $with_wrapper = false ) {
		...
		if ( Plugin::elementor()->preview->is_preview_mode( $post->ID ) ) {
			...
			if ( empty( $content ) ) {
				...
				wp_link_pages( [
					'before' => '<div class="page-links elementor-page-links"><span class="page-links-title elementor-page-links-title">' . __( 'Pages:', 'agile-elementor' ) . '</span>',
					'after' => '</div>',
					'link_before' => '<span>',
					'link_after' => '</span>',
					'pagelink' => '<span class="screen-reader-text">' . __( 'Page', 'agile-elementor' ) . ' </span>%',
